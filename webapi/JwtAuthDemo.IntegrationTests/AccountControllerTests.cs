...
public class AccountControllerTests
{
    ...
    public async Task ShouldReturnCorrectResponseForSuccessLogin()
    {
        ...
        Assert.AreEqual(string.Empty, loginResult.OriginalUserName);
        ...
        Assert.AreEqual(UserRoles.Admin, principal.FindFirstValue(ClaimTypes.Role));
    ...
    public async Task ShouldAllowAdminImpersonateOthers()
    {
        ...
        Assert.AreEqual(UserRoles.BasicUser, principal.FindFirstValue(ClaimTypes.Role));
        Assert.AreEqual(userName, principal.FindFirstValue("OriginalUserName"));
        Assert.IsNotNull(jwtSecurityToken);
    }
    ...
    public async Task ShouldAllowAdminToStopImpersonation()
    {
        ...
        Assert.AreEqual(UserRoles.Admin, principal.FindFirstValue(ClaimTypes.Role));
        Assert.IsTrue(string.IsNullOrWhiteSpace(principal.FindFirstValue("OriginalUserName")));
        Assert.IsNotNull(jwtSecurityToken);
    }
